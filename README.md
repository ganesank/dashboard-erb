...
[![Build Status](https://travis-ci.org/crsandeep/dashboard-erb.svg?branch=master)](https://travis-ci.org/crsandeep/dashboard-erb)

This is a boilerplate to build a full stack web application using React, Node.js, Express and Webpack. It is also configured with webpack-dev-server, eslint, prettier and babel.

- [dashboard-erb](#dashboard-erb)
...
git clone https://github.com/crsandeep/dashboard-erb
